...
Séptima. La validación del modelo de estimación de costos COCOMO II contrastado con los resultados empíricos del proyecto evidenció un Factor de Aceleración Metodológica de 1,68. Esto confirma de forma cuantitativa que la hibridación de las metodologías ágiles Feature-Driven Development (FDD) y Breakthrough Method for Agile AI-Driven Development (BMAD), sustentada por asistentes de programación con inteligencia artificial y el uso de componentes avanzados pre-construidos en Fluent UI v9 y FastAPI, incrementa la productividad general del desarrollador único en un 68% frente a los indicadores nominales de la ingeniería de software tradicional, logrando concluir el sistema completo en 5,0 meses reales en lugar de los 8,39 meses nominales calculados.
