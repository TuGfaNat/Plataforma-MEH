...
def absolute_fix_eventos():
    try:
        conn = psycopg2.connect(db_url)
        conn.autocommit = True
        cur = conn.cursor()
        
        print("Sincronización ABSOLUTA de la tabla de eventos...")
        ...
        add_col("id_organizador", "INTEGER REFERENCES usuarios(id_usuario)")
