...
```mermaid
graph LR
    API[Router: /api/v1/badges] --> Service[Service: badges_service.py]
...
|---|---|---|
| `Badges` | `id_bad` | `AuditMixin` presente |

### M3 — Contratos de APIs

| Método | URI Real | Body | Status |
|---|---|---|---|
| GET | `/api/v1/badges/` | Depende | 200/201 OK |\n| POST | `/api/v1/badges/` | Depende | 200/201 OK |\n| PUT | `/api/v1/badges/{id_badge}` | Depende | 200/201 OK |\n| DELETE | `/api/v1/badges/{id_badge}` | Depende | 200/201 OK |\n| GET | `/api/v1/badges/usuario/{id_usuario}` | Depende | 200/201 OK |\n| POST | `/api/v1/badges/asignar` | Depende | 200/201 OK |
