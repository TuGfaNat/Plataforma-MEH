...
sidebar_label: Recursos Estáticos
---
...
```mermaid
graph LR
    API[Router: /api/v1/recursos] --> Service[Service: recursos_service.py]
...
|---|---|---|
| `Recursos` | `id_rec` | `AuditMixin` presente |

### M3 — Contratos de APIs

| Método | URI Real | Body | Status |
|---|---|---|---|
| GET | `/api/v1/recursos/` | Depende | 200/201 OK |\n| POST | `/api/v1/recursos/` | Depende | 200/201 OK |\n| PUT | `/api/v1/recursos/{id_recurso}` | Depende | 200/201 OK |\n| DELETE | `/api/v1/recursos/{id_recurso}` | Depende | 200/201 OK |
