...
```mermaid
graph LR
    API[Router: /api/v1/certificados_admin] --> Service[Service: certificados_admin_service.py]
...
|---|---|---|
| `Certificados_admin` | `id_cer` | `AuditMixin` presente |

### M3 — Contratos de APIs

| Método | URI Real | Body | Status |
|---|---|---|---|
| POST | `/api/v1/certificados/bulk` | Depende | 200/201 OK |
