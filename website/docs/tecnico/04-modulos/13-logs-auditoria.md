---
id: 13-logs-auditoria
title: Logs / Auditoría
sidebar_label: Logs / Auditoría
---
...
|---|---|---|---|---|
| ADR-M13-001 | Uso de FastAPI Routers dedicados | Un solo router monolítico | Mejor separación de responsabilidades y modularidad | Mayor cantidad de archivos, pero código más mantenible |

### Sección M1 — Arquitectura del Módulo (C4 Nivel 3 + Ciclo de Vida)

```mermaid
graph TD
    Router[Router: /api/v1/logs] --> Service[Service Layer: logs_service.py]
...
Figura 1. *Diagrama ER de Logs / Auditoría.*
...
|---|---|---|---|
| GET | `/api/v1/logs` | - | `200 OK` |

### Sección M4 — Ingeniería Avanzada y Algoritmos Núcleo

Detalles de implementación específica para Logs / Auditoría.

### Sección M5 — Frontend

- **Ruta:** `/logs`
- **Conexión con backend:** Hook hacia `/api/v1/logs`
