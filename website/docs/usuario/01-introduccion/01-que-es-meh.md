...
id: 01-que-es-meh
title: ¿Qué es MEH?
sidebar_label: ¿Qué es MEH?
---

### ¿Qué es MEH?

#### ¿Para qué sirve?
Explicación de la misión y contexto del Microsoft Education Hub.
...
1. **Accede a la pantalla:** Ingresa a `¿Qué es MEH?` desde el menú lateral.
...
Descripción: Vista de la funcionalidad ¿Qué es MEH?
Texto alternativo: "Interfaz de ¿Qué es MEH? en Plataforma MEH"
Figura 1. Pantalla de ¿Qué es MEH?.
