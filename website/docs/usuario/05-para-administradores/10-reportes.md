...
#### ¿Para qué sirve?
Generación y exportación de reportes en Excel/CSV.
...
1. **Accede a la pantalla:** Ingresa a `Reportes` desde el menú lateral.
...
Descripción: Vista de la funcionalidad Reportes
Texto alternativo: "Interfaz de Reportes en Plataforma MEH"
Figura 1. Pantalla de Reportes.
