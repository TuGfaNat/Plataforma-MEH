...
id: 01-crear-evento
title: Crear Evento
sidebar_label: Crear Evento
---

### Crear Evento

#### ¿Para qué sirve?
Permite a los organizadores crear un nuevo evento, configurando capacidad, fechas y modalidades.
...
1. **Accede a la pantalla:** Ingresa a `Crear Evento` desde el menú lateral.
...
Descripción: Vista de la funcionalidad Crear Evento
Texto alternativo: "Interfaz de Crear Evento en Plataforma MEH"
Figura 1. Pantalla de Crear Evento.
