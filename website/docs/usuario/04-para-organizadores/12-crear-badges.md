...
id: 12-crear-badges
title: Crear Badges
sidebar_label: Crear Badges
---

### Crear Badges

#### ¿Para qué sirve?
Permite diseñar y otorgar insignias basadas en logros.
...
1. **Accede a la pantalla:** Ingresa a `Crear Badges` desde el menú lateral.
...
Descripción: Vista de la funcionalidad Crear Badges
Texto alternativo: "Interfaz de Crear Badges en Plataforma MEH"
Figura 1. Pantalla de Crear Badges.
