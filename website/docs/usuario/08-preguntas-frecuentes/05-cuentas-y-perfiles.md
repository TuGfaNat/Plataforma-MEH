---
id: 05-cuentas-y-perfiles
title: Cuentas y Perfiles
sidebar_label: Cuentas y Perfiles
---

### Cuentas y Perfiles

#### ¿Para qué sirve?
Preguntas comunes sobre la gestión de la cuenta personal.
...
1. **Accede a la pantalla:** Ingresa a `Cuentas y Perfiles` desde el menú lateral.
...
Descripción: Vista de la funcionalidad Cuentas y Perfiles
Texto alternativo: "Interfaz de Cuentas y Perfiles en Plataforma MEH"
Figura 1. Pantalla de Cuentas y Perfiles.
