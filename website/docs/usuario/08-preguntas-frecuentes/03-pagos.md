...
#### ¿Para qué sirve?
Preguntas comunes sobre métodos de pago y facturación.
...
1. **Accede a la pantalla:** Ingresa a `Pagos` desde el menú lateral.
...
Descripción: Vista de la funcionalidad Pagos
Texto alternativo: "Interfaz de Pagos en Plataforma MEH"
Figura 1. Pantalla de Pagos.
