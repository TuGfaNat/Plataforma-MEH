...
#### ¿Para qué sirve?
Preguntas comunes sobre el centro de aprendizaje.
...
1. **Accede a la pantalla:** Ingresa a `Cursos` desde el menú lateral.
...
Descripción: Vista de la funcionalidad Cursos
Texto alternativo: "Interfaz de Cursos en Plataforma MEH"
Figura 1. Pantalla de Cursos.
