      ...
      items: [
        {
          ...
          items: [
            'tecnico/vision-general/index-01-vision-general',
          ],
        },
        {
          type: 'category',
          ...
          items: [
            'tecnico/mapa-dependencias/index-02-mapa-dependencias',
          ],
        },
        {
          type: 'category',
          ...
          items: [
            'tecnico/decisiones-arquitectonicas/index-03-decisiones-arquitectonicas',
          ],
        },
        {
          type: 'category',
          label: '4. Módulos',
          items: [
            'tecnico/modulos/index-04-modulos',
            'tecnico/modulos/01',
            'tecnico/modulos/02',
            'tecnico/modulos/03',
            'tecnico/modulos/04',
        ...
        },
        {
          ...
          label: '5. Apéndices',
          items: [
            'tecnico/apendices/index-05-apendices',
          ],
        },
        'tecnico/historial-cambios',
      ],
    },
    {
      type: 'category',
